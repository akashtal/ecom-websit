        ...
        <div class="container h-100">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto h-100">
              ...
              <li class="nav-item">
                <a class="nav-link" href="index.php?page=add-product">
                  <i class="fas fa-shopping-cart"></i> Products
                </a>
              </li>

              <li class="nav-item">
                <a class="nav-link active" href="index.php?page=admin-accounts">
            ...
            <div class="tm-bg-primary-dark tm-block tm-block-settings">
              ...
              <form action="" class="tm-signup-form row">
                <div class="form-group col-lg-6">
                  <label for="name" style="color: black;">Account Name</label>
                  <input
                    id="name"
                    name="name"
                    type="text"
                ...
                <div class="form-group col-lg-6">
                  <label for="email" style="color: black;">Account Email</label>
                  <input
                    id="email"
                    name="email"
                    type="email"
